...
define("samples/scenes/temp", ["require", "exports", "editor/elements/HTMLElement", "editor/elements/view/View", "editor/model/Model"], function (require, exports, HTMLElement_22, View_1, Model_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.temp = void 0;
    function temp() {
        ...
        const FieldFragment = (fieldset, field) => HTMLElement_22.Fragment(HTMLElement_22.Element(
        /*html*/ `<div>`, {
            children: [
        ...
        const DropzoneInputFragment = (host, field) => HTMLElement_22.Fragment(HTMLElement_22.Element(/*html*/ `<e-dropzoneinput>`, {
            children: [
                HTMLElement_22.ReactiveNode(HTMLElement_22.Element(/*html*/ `<e-dropzone>`, {
                    props: {
                ...
                HTMLElement_22.Element(/*html*/ `<input>`, {
                    props: {
        ...
        class StatementFieldsetView extends View_1.ViewBase {
            ...
            render() {
                return HTMLElement_22.Element(/*html*/ `<fieldset>`, {
                    props: {
        ...
        class StatementLastExecutionView extends View_1.ViewBase {
            ...
            render() {
                return HTMLElement_22.Element(/*html*/ `<div>`, {
                    children: [
        ...
        class StatementResultView extends View_1.ViewBase {
            ...
            render() {
                return HTMLElement_22.Element(/*html*/ `<e-dragzone>`, {
                    children: HTMLElement_22.ReactiveChildNodes(this.model.columns, (item) => HTMLElement_22.Element(/*html*/ `<e-draggable>`, {
                        props: {
        ...
        class ExpressionDraggableView extends View_1.ViewBase {
            ...
            render() {
                return HTMLElement_22.ReactiveNode(HTMLElement_22.Element(/*html*/ `<e-draggable>`), this.model, (draggable, property, oldValue, newValue) => {
                    switch (property) {
                        case "label":
                            if (newValue !== oldValue) {
    ...
    class EditorBase extends EventDispatcher_2.EventDispatcher {
        ...
        */
        ...
        setup() {
            ...
            document.body.addEventListener("trigger", (event) => {
                let target = event.target;
                if (HTMLElement_29.isTagElement("e-menuitem", target)) {
                    if (target.command) {
...
define("samples/Sandbox", ["require", "exports", "editor/elements/HTMLElement", "samples/scenes/Mockup", "samples/scenes/temp"], function (require, exports, HTMLElement_31, Mockup_1, temp_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("editor/elements/lib/math/Vector3Input", ["require", "exports", "editor/elements/HTMLElement", "engine/libs/maths/algebra/vectors/Vector3"], function (require, exports, HTMLElement_40, Vector3_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    let Vector3InputElement = class Vector3InputElement extends HTMLElement {
        ...
        `);
            this.vector = new Vector3_1.Vector3();
    ...
    Vector3InputElement = __decorate([
        ...
        HTMLElement_40.GenerateAttributeAccessors([
            { name: 'label' },
            { name: 'tooltip' }
        ])
    ], Vector3InputElement);
...
define("editor/elements/lib/misc/Palette", ["require", "exports", "editor/elements/HTMLElement"], function (require, exports, HTMLElement_41) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    let PaletteElement = class PaletteElement extends HTMLElement {
        constructor() {
            super();
            HTMLElement_41.bindShadowRoot(this, /*template*/ `
            <style>
                :host {
                    display: block;
                    content: contains;
    ...
    PaletteElement = __decorate([
        HTMLElement_41.RegisterCustomHTMLElement({
            name: 'e-palette'
        }),
        HTMLElement_41.GenerateAttributeAccessors([{ name: 'colors', type: 'json' }])
    ], PaletteElement);
...
define("editor/templates/other/DraggableInputTemplate", ["require", "exports", "editor/elements/HTMLElement"], function (require, exports, HTMLElement_42) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.HTMLDraggableInputTemplate = void 0;
    const HTMLDraggableInputTemplate = (desc) => {
        return HTMLElement_42.HTMLElementConstructor("e-draggable", {
            props: {
                id: desc.id,
                className: desc.className
            },
            children: [
                HTMLElement_42.HTMLElementConstructor("input", {
                    props: {
                        name: desc.name,
                        hidden: true
                    }
...
define("editor/templates/table/TableTemplate", ["require", "exports", "editor/elements/HTMLElement"], function (require, exports, HTMLElement_43) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.HTMLTableTemplate = void 0;
    const HTMLTableTemplate = (desc) => {
        const thead = HTMLElement_43.HTMLElementConstructor("thead", {
            children: [
                HTMLElement_43.HTMLElementConstructor("tr", {
                    props: {
                        id: desc.id,
                        className: desc.className,
                    },
                    children: desc.headerCells.map((cell) => {
                        return HTMLElement_43.HTMLElementConstructor("th", {
                            props: {
                                scope: "col"
                            },
                            children: [
        ...
        const tbody = HTMLElement_43.HTMLElementConstructor("tbody", {
            children: desc.bodyCells.map((row) => {
                return HTMLElement_43.HTMLElementConstructor("tr", {
                    props: {
                        id: desc.id,
                        className: desc.className,
                    },
                    children: row.map((cell) => {
                        if ((typeof cell === "object") && !(cell instanceof Node) && ("type" in cell)) {
                            switch (cell.type) {
                                case "data":
                                default:
                                    return HTMLElement_43.HTMLElementConstructor("td", {
                                        children: [
                                            cell.content
                                        ]
                                    });
        ...
        const tfoot = HTMLElement_43.HTMLElementConstructor("tfoot", {
            children: [
                HTMLElement_43.HTMLElementConstructor("tr", {
                    props: {
                        id: desc.id,
        ...
        const table = HTMLElement_43.HTMLElementConstructor("table", {
            props: {
                id: desc.id,
                className: desc.className,
            },
...
define("samples/temp", ["require", "exports", "editor/elements/HTMLElement", "editor/elements/view/View", "editor/model/Model"], function (require, exports, HTMLElement_44, View_2, Model_3) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.temp = void 0;
    function temp() {
        class FieldModel extends Model_3.ObjectModelBase {
            constructor(data) {
                super(data);
            }
        }
        class FieldsetModel extends Model_3.ObjectModelBase {
            constructor(data) {
                super(data);
                this.fields = new Model_3.ListModelBase(data.fields.map(field => new FieldModel(field)));
            }
            getData() {
                return Object.assign(this.data, {
                    fields: this.fields.items.map(item => item.data)
        ...
        class StatementLastExecutionModel extends Model_3.ObjectModelBase {
            constructor(data) {
                super(data);
            }
        }
        class DataframeColumnModel extends Model_3.ObjectModelBase {
            constructor(data) {
                super(data);
            }
        }
        class StatementResultModel extends Model_3.ObjectModelBase {
            constructor(data) {
                super(data);
                this.columns = new Model_3.ListModelBase(data.columns.map((column) => new DataframeColumnModel(column)));
            }
            getData() {
                return Object.assign(this.data, {
                    columns: this.columns.items.map(item => item.data)
        ...
        const FieldFragment = (fieldset, field) => HTMLElement_44.Fragment(HTMLElement_44.Element(
        /*html*/ `<div>`, {
            children: [
                HTMLElement_44.ReactiveNode(HTMLElement_44.Element(/*html*/ `<label>`), field, (div, property, oldValue, newValue) => {
                    switch (property) {
                        case "label":
                            if (newValue !== oldValue) {
                                div.textContent = field.data.label;
        ...
        const DropzoneInputFragment = (host, field) => HTMLElement_44.Fragment(HTMLElement_44.Element(/*html*/ `<e-dropzoneinput>`, {
            children: [
                HTMLElement_44.ReactiveNode(HTMLElement_44.Element(/*html*/ `<e-dropzone>`, {
                    props: {
                        className: "field__dropzone",
                        slot: "dropzone",
                        droptest: (dropzone, draggables) => {
                ...
                HTMLElement_44.Element(/*html*/ `<input>`, {
                    props: {
                        className: "field__input",
                        slot: "input"
                    }
        ...
        class StatementFieldsetView extends View_2.ViewBase {
            constructor(model) {
                super(model);
            }
            render() {
                return HTMLElement_44.Element(/*html*/ `<fieldset>`, {
                    props: {
                        className: "statement-fieldset"
                    },
                    children: HTMLElement_44.ReactiveChildNodes(this.model.fields, (item) => FieldFragment(this.element, item))
                });
            }
        }
        class StatementLastExecutionView extends View_2.ViewBase {
            constructor(model) {
                super(model);
            }
            render() {
                return HTMLElement_44.Element(/*html*/ `<div>`, {
                    children: [
                        HTMLElement_44.ReactiveNode(document.createTextNode(`Last execution date : ${this.model.data.datetime}`), this.model, (node, property, oldValue, newValue) => {
                            if (property === "datetime") {
                                node.textContent = `Last execution date : ${newValue}`;
                            }
                        })
        ...
        class StatementResultView extends View_2.ViewBase {
            constructor(model) {
                super(model);
            }
            render() {
                return HTMLElement_44.Element(/*html*/ `<e-dragzone>`, {
                    children: HTMLElement_44.ReactiveChildNodes(this.model.columns, (item) => HTMLElement_44.Element(/*html*/ `<e-draggable>`, {
                        props: {
                            textContent: item.data.name
                        }
                    }))
        ...
        class ExpressionDraggableView extends View_2.ViewBase {
            constructor(model) {
                super(model);
            }
            render() {
                return HTMLElement_44.ReactiveNode(HTMLElement_44.Element(/*html*/ `<e-draggable>`), this.model, (draggable, property, oldValue, newValue) => {
                    switch (property) {
                        case "label":
                            if (newValue !== oldValue) {
                                HTMLElement_44.setElementChildren(draggable, HTMLElement_44.parseStringTemplate(this.model.data.label, this.model.fields.items.reduce((obj, item) => ({
                                    ...obj,
                                    [item.data.name]: DropzoneInputFragment(this.element, item)
                                }), {})).childNodes);
                            }
...
`;
    async function mockup() {
        ...
        if (importMenuItem) {
            importMenuItem.command = "import";
            importMenuItem.hotkey = new Input_3.HotKey(Input_3.Key.I, Input_3.KeyModifier.Control, Input_3.KeyModifier.Alt);
        }
        let exportMenuItem = document.getElementById("file-export-menu-button");
        if (exportMenuItem) {
            exportMenuItem.command = "export";
            exportMenuItem.hotkey = new Input_3.HotKey(Input_3.Key.J, Input_3.KeyModifier.Control, Input_3.KeyModifier.Alt);
        }
        const extractForm = document.querySelector("form#extract-form");
        const extractTab = document.querySelector("e-tab[name='extract']");
        const transformTab = document.querySelector("e-tab[name='transform']");
        ...
        if (treeviewlist) {
            treeviewlist.addEventListener("contextmenu", (event) => {
                let target = event.target;
                console.log(target);
                if (HTMLElement_45.isTagElement("e-treeviewitem", target)) {
                    let menu = HTMLElement_45.Element("<e-menu>", {
                        props: {
                            name: "My menu"
                        },
                        children: [
                            HTMLElement_45.Element("<e-menuitem>", {
                                props: {
                                    label: "Remove me!"
                                },
                                children: [
                                    HTMLElement_45.Element("<span>", {
                                        props: {
                                            slot: "label",
                                            className: "menuitem__icon"
                                        }
