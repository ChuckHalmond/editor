...
class TreeModel extends ModelObject {
    constructor(init) {
        ...
        const { items = [], sortFunction } = init !== null && init !== void 0 ? init : {};
        ...
        this.sortFunction = sortFunction !== null && sortFunction !== void 0 ? sortFunction : function (item_a, item_b) {
...
let TreeViewBase = class TreeViewBase extends View {
    constructor(model) {
        ...
        this.setModel(model !== null && model !== void 0 ? model : new TreeModel());
    }
...
_TreeViewBase_dragImages = new WeakMap(), _TreeViewBase_instances = new WeakSet(), _TreeViewBase_getTreeItemElementUri = function _TreeViewBase_getTreeItemElementUri(item) {
    ...
    while (closestItem !== null) {
        ...
        uri = `${dataset.id}/` + uri;
        closestItem = (_a = parentElement === null || parentElement === void 0 ? void 0 : parentElement.closest("e-treeitem")) !== null && _a !== void 0 ? _a : null;
    }
    return uri;
}, _TreeViewBase_getDragImage = function _TreeViewBase_getDragImage(model) {
    var _a, _b;
    return (_b = (_a = __classPrivateFieldGet(this, _TreeViewBase_dragImages, "f").get(model)) === null || _a === void 0 ? void 0 : _a.deref()) !== null && _b !== void 0 ? _b : null;
