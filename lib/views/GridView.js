...
class GridModel extends ModelObject {
    constructor(init) {
        super();
        const { rows: initRows = [], columns: initColumns = [] } = init !== null && init !== void 0 ? init : {};
    ...
    getColumnByName(name) {
        var _a;
        return (_a = Array.from(this.columns.values()).find(column_i => column_i.name == name)) !== null && _a !== void 0 ? _a : null;
    }
...
let GridViewBase = class GridViewBase extends View {
    constructor(model) {
        ...
        this.setModel(model !== null && model !== void 0 ? model : new GridModel());
    }
