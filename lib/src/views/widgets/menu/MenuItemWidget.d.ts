...
declare var menuItemWidget: {
    "__#37@#iconPartTemplate": HTMLElement;
    "__#37@#arrowPartTemplate": HTMLElement;
    "__#37@#keyshortcutsPartTemplate": HTMLElement;
    "__#37@#template": HTMLElement;
    "__#37@#types": MenuItemType[];
    "__#37@#typesFeatures": {
        button: {
            role: string;
            hasIcon: boolean;
    ...
    slottedCallback(item: HTMLElement, slot: HTMLElement): void;
    "__#37@#label"(item: HTMLElement): HTMLElement;
    getMenu(item: HTMLElement): HTMLElement | null;
    getKeyShortcut(item: HTMLElement): string | null;
    setKeyShortcut(item: HTMLElement, value: string | null): void;
    getLabel(item: HTMLElement): string;
    ...
    "__#37@#positionMenu"(item: HTMLElement): void;
};
