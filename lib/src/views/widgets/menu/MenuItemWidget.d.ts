...
declare var menuItemWidget: {
    "__#13303@#iconPartTemplate": HTMLElement;
    "__#13303@#arrowPartTemplate": HTMLElement;
    "__#13303@#keyshortcutsPartTemplate": HTMLElement;
    "__#13303@#template": HTMLElement;
    "__#13303@#types": MenuItemType[];
    "__#13303@#typesFeatures": {
        button: {
            role: string;
            hasIcon: boolean;
            hasArrow: boolean;
    ...
    slottedCallback(item: HTMLElement, slot: HTMLElement): void;
    "__#13303@#label"(item: HTMLElement): HTMLElement;
    getMenu(item: HTMLElement): HTMLElement | null;
    getKeyShortcut(item: HTMLElement): string | null;
    setKeyShortcut(item: HTMLElement, value: string | null): void;
    getLabel(item: HTMLElement): string;
    ...
    expand(item: HTMLElement): void;
    collapse(item: HTMLElement): void;
    "__#13303@#handleClickEvent"(event: MouseEvent): void;
    "__#13303@#positionMenu"(item: HTMLElement): void;
};
