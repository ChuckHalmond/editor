...
declare var toolbarItemWidget: {
    ...
    "__#54@#handleClickEvent"(event: MouseEvent): void;
    "__#54@#positionMenu"(item: HTMLElement): void;
    "__#54@#label"(item: HTMLElement): HTMLElement;
};
