...
declare var toolbarItemWidget: {
    ...
    "__#27@#handleClickEvent"(event: MouseEvent): void;
    "__#27@#positionMenu"(item: HTMLElement): void;
    "__#27@#label"(item: HTMLElement): HTMLElement;
};
