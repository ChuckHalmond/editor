import { isListModel, isObjectModel } from "../models/Model";
...
function isReactiveNode(node) {
    return typeof node._reactAttributes === "object" &&
        node._reactAttributes._reactEvent === "objectmodelchange" &&
        typeof node._reactAttributes._reactListener === "function" &&
        isObjectModel(node._reactAttributes._reactModel) ||
        isListModel(node._reactAttributes._reactModel);
}
function isReactiveParentNode(node) {
    return typeof node._reactAttributes === "object" &&
        node._reactAttributes._reactEvent === "listmodelchange" &&
        typeof node._reactAttributes._reactListener === "function" &&
        isListModel(node._reactAttributes._reactModel);
}
