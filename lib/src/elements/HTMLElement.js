...
function isReactiveNode(node) {
    return typeof node._reactAttributes === "object" &&
        typeof node._reactAttributes.addReactListener === "function" &&
        typeof node._reactAttributes.removeReactListener === "function";
}
...
function ReactiveChildNodes(list, map, emptyNode) {
    return (parent) => {
        const listener = (event) => {
