    ...
    let HTMLEMenuElementBase = class HTMLEMenuElementBase extends HTMLElement {
        ...
        connectedCallback() {
            ...
            if (slot) {
                slot.addEventListener("slotchange", () => {
                    const items = slot.assignedElements().filter(elem => (0, HTMLElement_1.isTagElement)("e-menuitem", elem) || (0, HTMLElement_1.isTagElement)("e-menuitemgroup", elem));
                    this.items = items;
                    items.forEach((item) => {
            ...
            this.addEventListener("keydown", (event) => {
                switch (event.key) {
                    case "ArrowUp":
                        ...
                        if ((0, HTMLElement_1.isTagElement)("e-menuitemgroup", this.activeItem)) {
                    ...
                    case "End":
                        ...
                        break;
                    case "Enter":
                        if ((0, HTMLElement_1.isTagElement)("e-menuitem", this.activeItem)) {
                    ...
                    case "Escape":
                        if (this.parentItem) {
                            ...
                            if ((0, HTMLElement_1.isTagElement)("e-menu", parentMenu)) {
                                if (parentGroup) {
                    ...
                    case "ArrowRight":
                        if (this.items.includes(event.target)) {
                            if ((0, HTMLElement_1.isTagElement)("e-menuitem", this.activeItem) && this.activeItem.childMenu) {
        ...
        focusItemAt(index, childMenu) {
            ...
            if (item) {
                ...
                item.focus();
                if ((0, HTMLElement_1.isTagElement)("e-menuitem", item)) {
        ...
        reset() {
            ...
            this._activeIndex = -1;
            if ((0, HTMLElement_1.isTagElement)("e-menuitem", item) && item.childMenu) {
        ...
        findItem(predicate, subitems) {
            ...
            for (let idx = 0; idx < this.items.length; idx++) {
                ...
                else if ((0, HTMLElement_1.isTagElement)("e-menuitemgroup", item)) {
