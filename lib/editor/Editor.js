define(["require", "exports", "src/libs/commands/Command", "src/libs/events/EventDispatcher", "./elements/HTMLElement", "./elements/Snippets", "./templates/menus/MenubarTemplate"], function (require, exports, Command_1, EventDispatcher_1, HTMLElement_1, Snippets_1, MenubarTemplate_1) {
    "use strict";
    ...
    */
    class EditorBase extends EventDispatcher_1.EventDispatcher {
        ...
        */
        ...
        getState(key) {
            return (0, Snippets_1.getPropertyFromPath)(this._state, key);
        }
        //TODO: Create a listeners object with the same structure as the state object
        setState(key, value) {
            (0, Snippets_1.setPropertyFromPath)(this._state, key, value);
            ...
            listenedStates.filter((state) => {
                ...
                if (stateListeners) {
                    let newStateValue = (state.length === key.length) ? value :
                        (state.length >= key.length) ? (0, Snippets_1.getPropertyFromPath)(value, state.substring(key.length + 1)) :
                            (0, Snippets_1.getPropertyFromPath)(this._state, state);
