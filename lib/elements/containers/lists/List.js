    ...
    switch (key) {
        case "a": {
            ...
            if (ctrlKey) {
                const walker = __classPrivateFieldGet(this, _HTMLEListElementBase_walker, "f");
                const { root } = walker;
                const firstItem = (walker.currentNode = (_a = walker.parentNode()) !== null && _a !== void 0 ? _a : root, walker.firstChild());
                const lastItem = (walker.currentNode = (_b = walker.parentNode()) !== null && _b !== void 0 ? _b : root, walker.lastChild());
