...
_HTMLETreeElementBase_onSelection = new WeakMap(), _HTMLETreeElementBase_hasSelectionChanged = new WeakMap(), _HTMLETreeElementBase_walker = new WeakMap(), _HTMLETreeElementBase_instances = new WeakSet(), _HTMLETreeElementBase_nodeFilter = function _HTMLETreeElementBase_nodeFilter(node) {
    ...
    return (type === "leaf" ?
        ...
        expanded ?
            walker.nextNode() :
            (_a = walker.nextSibling()) !== null && _a !== void 0 ? _a : (walker.parentNode(), walker.nextSibling()));
        ...
        case "a": {
            ...
            if (ctrlKey) {
                if (activeItem) {
                    ...
                    const firstItem = (walker.currentNode = (_a = walker.parentNode()) !== null && _a !== void 0 ? _a : this, walker.firstChild());
                    const lastItem = (walker.currentNode = (_b = walker.parentNode()) !== null && _b !== void 0 ? _b : this, walker.lastChild());
