...
_HTMLEGridElementBase_onSelection = new WeakMap(), _HTMLEGridElementBase_hasSelectionChanged = new WeakMap(), _HTMLEGridElementBase_cellsWalker = new WeakMap(), _HTMLEGridElementBase_rowsWalker = new WeakMap(), _HTMLEGridElementBase_instances = new WeakSet(), _HTMLEGridElementBase_cellsWalkerNodeFilter = function _HTMLEGridElementBase_cellsWalkerNodeFilter(node) {
    ...
    switch (key) {
        ...
        case "ArrowUp": {
            switch (selectby) {
                case "cell": {
                    const firstRow = activeRow !== null && activeRow !== void 0 ? activeRow : __classPrivateFieldGet(this, _HTMLEGridElementBase_instances, "m", _HTMLEGridElementBase_firstRow).call(this);
        ...
        case "ArrowDown": {
            switch (selectby) {
                case "cell":
                    {
                        const lastRow = activeRow !== null && activeRow !== void 0 ? activeRow : __classPrivateFieldGet(this, _HTMLEGridElementBase_instances, "m", _HTMLEGridElementBase_lastRow).call(this);
