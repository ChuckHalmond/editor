...
let HTMLETabListElementBase = class HTMLETabListElementBase extends HTMLElement {
    ...
    connectedCallback() {
        ...
        const tabToSelect = selectedTab !== null && selectedTab !== void 0 ? selectedTab : this.firstItem();
        if (tabToSelect) {
...
_HTMLETabListElementBase_walker = new WeakMap(), _HTMLETabListElementBase_instances = new WeakSet(), _HTMLETabListElementBase_walkerNodeFilter = function _HTMLETabListElementBase_walkerNodeFilter(node) {
    ...
    if (!this.contains(relatedTarget)) {
        (_a = (selectedTab !== null && selectedTab !== void 0 ? selectedTab : this.firstItem())) === null || _a === void 0 ? void 0 : _a.focus();
    }
    ...
    switch (key) {
        case "ArrowLeft": {
            const previousTab = activeTab ?
                (_a = __classPrivateFieldGet(this, _HTMLETabListElementBase_instances, "m", _HTMLETabListElementBase_previousItem).call(this, activeTab)) !== null && _a !== void 0 ? _a : __classPrivateFieldGet(this, _HTMLETabListElementBase_instances, "m", _HTMLETabListElementBase_lastItem).call(this) :
                this.firstItem();
            previousTab === null || previousTab === void 0 ? void 0 : previousTab.focus({ preventScroll: true });
            event.stopPropagation();
            break;
        }
        case "ArrowRight": {
            const nextTab = activeTab ?
                (_b = __classPrivateFieldGet(this, _HTMLETabListElementBase_instances, "m", _HTMLETabListElementBase_nextItem).call(this, activeTab)) !== null && _b !== void 0 ? _b : this.firstItem() :
                __classPrivateFieldGet(this, _HTMLETabListElementBase_instances, "m", _HTMLETabListElementBase_lastItem).call(this);
            nextTab === null || nextTab === void 0 ? void 0 : nextTab.focus({ preventScroll: true });
            event.stopPropagation();
            break;
        }
        case "Home": {
